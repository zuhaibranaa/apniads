            ...
            <div class="col-lg-5 col-md-8 align-item-center">
                <div class="border">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        @csrf
                        <fieldset class="p-4">
                            <input type="email" id="email" placeholder="Email" class="border p-3 w-100 my-2 @error('email') is-invalid @enderror" name="email" required autofocus>
                            <input type="password" placeholder="Password" name="password" class="border p-3 w-100 my-2 @error('password') is-invalid @enderror">
