...
<section class="section-sm">
	...
	<ul class="category-list">
		...
		<li><a href="{{url('category/'.$category['id'])}}">{{$category['name']}} <span>{{count(\App\Models\Ad::all()->where('category_id','=',$category['id']))}}</span></a></li>
        @endforeach
	</ul>
</div>
{{--
...
<a href="{{url('ad/'.$ad['id'])}}">
<img class="card-img-top img-fluid" src="{{asset('images/'.$ad['images'])}}" alt="Card image cap">
</a>
</div>
<div class="card-body">
