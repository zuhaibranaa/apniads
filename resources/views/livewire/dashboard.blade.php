            ...
            <div class="widget user-dashboard-menu">
              <ul>
                ...
                @if (auth()->user()->is_admin)
                    <li><a href="dashboard-my-ads.html"><i class="fa fa fa-check-square-o"></i> All Ads</a></li>
                @endif
                <li><a href="dashboard-pending-ads.html"><i class="fa fa-bolt"></i> Pending Approval<span>{{$count}}</span></a></li>
