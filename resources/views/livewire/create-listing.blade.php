            ...
            <fieldset class="border border-gary p-4 mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="range" step="10" min="0" max="100" class="border w-100 p-2 bg-white text-capitalize">

                            <h6 class="font-weight-bold pt-4 pb-1">Brand:</h6>
                            <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="Brand Name go There">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="price">
                                ...
                                <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="Build Model">
                                <h6 class="font-weight-bold pt-4 pb-1">Specifications:</h6>
                                <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="Ad Specifications">
