            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
                    ...
                    <div class="row">
                            ...
                            <div class="widget personal-info">
                                ...
                                <form method="POST" action="{{ url('profile/' . auth()->user()->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="first-name"
                        ...
                        <input style="align-content: center; margin-left: 20rem; margin-right: 20rem" type="submit"
                            class="btn btn-transparent" value="Save My Changes" />
                        </form>
                        <div class="col-lg-6 col-md-6">
                        </div>
                    </div>
